...
const Cadastro = () => {
  ...
  const [form, setForm] = useState({ empresa: "", site: "", nome: "", email: "", celular: "", senha: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!site) {
      setError("O site da empresa é obrigatório.");
      return;
    }
    if (senha.length < 8) {
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#fff8f2] p-6">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 rounded-2xl shadow-xl bg-white border-slate-200">
          <h2 className="text-3xl font-semibold text-slate-900 mb-6">Cadastro</h2>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="empresa" className="block mb-1 font-semibold text-slate-700">
                Nome da empresa
              </label>
              <Input
                id="empresa"
            ...
            <div>
              <label htmlFor="nome" className="block mb-1 font-semibold text-slate-700">
                Nome
              </label>
              <Input
                id="nome"
            ...
            <div>
              <label htmlFor="celular" className="block mb-1 font-semibold text-slate-700">
                Celular
              </label>
              <Input
                id="celular"
            ...
            <div className="mt-2 text-center">
              <Link to="/login" className="text-sm text-slate-700 hover:text-slate-900 transition-colors underline underline-offset-2">
